...
from services.openrouter_service import analyze_file_deep
from utils.pattern_scorer import (
...
async def analyze_code_review_stream(repo_url: str) -> AsyncGenerator[str, None]:
    ...
    try:
        ...
        from services.code_scan_regex import collect_code_files
        ...
        grouped_files = [{"path": k, "findings": v} for k, v in files_dict.items()]

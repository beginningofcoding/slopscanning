...
import { getRepoAuditAnalyzeUrl } from '@/lib/api';
import ProgressStream from '@/components/ui/ProgressStream';
import SignalsPanel from '@/components/shared/SignalsPanel';
import LimitationsPanel from '@/components/repo-audit/AuditLimitationsPanel';
...
export default function RepoAuditClient({ owner, name, autoStart = false }) {
  const repoUrl = `https://github.com/${owner}/${name}`;
  const { events, status, result, error, start } = useAnalyzeSse(getRepoAuditAnalyzeUrl);
